...
#include "envoy/config/filter/v2/http/buffer.pb.validate.h"
#include "envoy/config/filter/v2/http/fault.pb.validate.h"
#include "envoy/config/filter/v2/http/health_check.pb.validate.h"
#include "envoy/config/filter/v2/http/gzip.pb.validate.h"
#include "envoy/config/filter/v2/http/lua.pb.validate.h"
