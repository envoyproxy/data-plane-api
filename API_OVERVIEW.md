...
* [Endpoint Discovery Service (EDS)](envoy/service/discovery/v2/eds.proto). This has the same role as SDS in the [v1 API](https://www.envoyproxy.io/docs/envoy/latest/configuration/cluster_manager/sds_api.html),
...
* [Health Discovery Service (HDS)](envoy/service/discovery/v2/hds.proto). This new API supports efficient endpoint health discovery by the management server via the Envoy instances it manages. Individual Envoy instances
  ...
  EDS endpoints.
* [Listener Discovery Service (LDS)](envoy/service/discovery/v2/lds.proto). This new API supports dynamic discovery of the listener configuration (which ports to bind to, TLS details, filter chains, etc.).
...
* [Route Discovery Service (RDS)](envoy/service/discovery/v2/rds.proto).
...
* [Aggregated Discovery Service (ADS)](envoy/service/discovery/v2/ads.proto). See
