...
See the reference for :ref:`UpstreamTlsContexts <envoy_api_msg_cert.UpstreamTlsContext>` and
:ref:`DownstreamTlsContexts <envoy_api_msg_cert.DownstreamTlsContext>` for other TLS options.
